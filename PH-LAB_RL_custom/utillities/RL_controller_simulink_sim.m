...
% SAC_agent.env.training = training;
% SAC_agent.env.SA_delay = SA_delay;
% SAC_agent.env.SA_noise_bias = SA_noise_bias;
...
applied_action(1,:) = action(1,:);
internal_state(1,:) = state(1,1:length(simulink_env.state_vars));
...
title("Simulink, nMAE(\theta,\theta_{ref}) = " + 100*nMAE + "%" + " idx=" + num2str(idx))
